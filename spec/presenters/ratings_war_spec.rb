...
describe WAR do
  it "enough ratings for a 3 year average" do
    ...
    Factory(:icu_rating, rating: 2000, list: "2008-09-01", icu_player: p1)
    Factory(:icu_rating, rating: 2100, list: "2009-09-01", icu_player: p1)
    Factory(:icu_rating, rating: 2200, list: "2010-09-01", icu_player: p1)
    f1 = Factory(:fide_player, icu_player: p1)
    Factory(:fide_rating, rating: 2000, list: "2008-11-01", fide_player: f1)
    Factory(:fide_rating, rating: 2100, list: "2009-11-01", fide_player: f1)
    Factory(:fide_rating, rating: 2200, list: "2010-11-01", fide_player: f1)
    Factory(:fide_rating, rating: 2300, list: "2011-01-01", fide_player: f1)
    p2 = Factory(:icu_player, gender: "F")
    Factory(:icu_rating, rating: 1200, list: "2008-09-01", icu_player: p2)
    Factory(:icu_rating, rating: 1100, list: "2009-09-01", icu_player: p2)
    Factory(:icu_rating, rating: 1000, list: "2010-09-01", icu_player: p2)
    p3 = Factory(:icu_player)
    Factory(:icu_rating, rating: 1800, list: "2008-09-01", icu_player: p3, full: false)
    Factory(:icu_rating, rating: 1900, list: "2009-09-01", icu_player: p3)
    Factory(:icu_rating, rating: 2000, list: "2010-09-01", icu_player: p3)
    f3 = Factory(:fide_player, icu_player: p3)
    Factory(:fide_rating, rating: 2100, list: "2010-11-01", fide_player: f3)
