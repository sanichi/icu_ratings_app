...
describe WAR do
  it "enough ratings for a 3 year average" do
    ...
    Factory(:fide_rating, rating: 2000, list: "2009-11-01", fide_player: f1)
    Factory(:fide_rating, rating: 2100, list: "2010-11-01", fide_player: f1)
    Factory(:fide_rating, rating: 2200, list: "2011-11-01", fide_player: f1)
    Factory(:fide_rating, rating: 2300, list: "2012-01-01", fide_player: f1)
    ...
    Factory(:fide_rating, rating: 2100, list: "2011-11-01", fide_player: f3)
