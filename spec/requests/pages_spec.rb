...
describe "Pages" do
  ...
  describe "/my_home" do
    ...
    it "player with recent tournaments and published ratings" do
      ...
      page.should have_selector(:xpath, "//table[@id='recent_tournaments']/tr[td='%s']/td[contains(.,'%d')]" % [@t1.name_with_year, p1.rating_change])
      page.should have_selector(:xpath, "//table[@id='recent_tournaments']/tr[td='%s']/td[contains(.,'%d')]" % [@t2.name_with_year, p2.rating_change])
